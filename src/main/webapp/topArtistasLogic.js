...
function AñadirDiv(nombreArtista, foto, descripcion, puntaje) {
    ...
    var div = document.createElement("div"); 
               ...
               document.getElementById("iteracion" + nombreArtista).innerHTML ="<div class=\"numero\"> <h2>1</h2> </div><div class=\"vl\"></div><div class=\"nombre\"><h3>Autor: <center id=\" autor\"><br>"+nombreArtista+"</center></h3></div><div class=\"obrasNum\"> <h3>Obras: <center id=\"obrasNum\"><br>5</center></h3></div><div class =\"puntaje\"><h3>Puntaje: <center id=\"puntaje\"><br>"+puntaje+ "</center></h3></div><div><img class=\"fotoAutor\"  src=\""+ foto +"\"></div> ";
